 ...
 */
public class PrimTemplateMaxTree {
	...
	public static void main(String[] args) {
		...
		while (!q.isEmpty()) {
			...
			for (Pair nxt : adj[cur]) {
				...
				//purposely store the inverse of weight (ex 50 becomes -50 and 25 becomes -25) so that the max weight (temporarily stored as the smallest) can be picked from the PriorityQueue
				q.add(new Pair(-w, b)); 
			}
		}
